...
Description : Populate the Domain tables of the Ontime Casefill Customer Domain
Name : klg_nga_kna.sales_exec.sp_cust_serv_cust_order_fulfl
Revisions :
Input Parameter : from_dt, to_dt
Output Parameter :

Version         Date            Author              Description
---------       ----------      ---------------     ----------------------------------------------------------------------------------------
1.0             10/18/2022      Anamika             Initial Version.
2.0             10/31/2022      Pranit Bhujel       Added the common timestamp columns in the final table.
3.0             11/25/2022      Pranit Bhujel       Added the correct model name and other nomenclature.
4.0             11/30/2022      Pranit Bhujel       Changed the model to meet the NGA Approved list.
============================================================================================================================================
*/
